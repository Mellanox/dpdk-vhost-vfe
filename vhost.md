...
3. Bind PCIe VF device to vfio-pci driver and enable SR-IOV.
    * Bind the virtio-net PF devices to vfio-pci driver and create 1 virtio-net VF:
            ...
            Add a VF representor to the OVS bridge on the DPU: 
            ...
            Add virtio-net PF and VF to vhost acceleration service.
    ...
    * Bind the virtio-blk PF devices to vfio-pci driver and create 1 virtio-blk VF:
            ...
            Create block device on the DPU: 
            ...
            Add virtio-blk PF and VF to vhost acceleration service.
...
4. Add VF device to vhostd service with vhost domain socket path:
